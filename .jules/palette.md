...
## 2024-06-11 - Adding aria-pressed to custom selection pickers
...
**Action:** Always add `aria-pressed` to buttons that act as toggle options in custom single-select groups.
