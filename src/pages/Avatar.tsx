...
export default function Avatar() {
  ...
  return (
    ...
    >
      {/* ── Background: warm room wall + wood floor (LEFT) | wardrobe photo (RIGHT) ── */}
      {/* Left — room atmosphere matching the wardrobe photo palette */}
      <div
      ...
      />
      {/* Right — the actual wardrobe photo */}
      <div
      ...
      {/* Seam blend between the two halves */}
      <div
      ...
      {/* ── Avatar canvas — left 55% of screen, avatar floats over room ── */}
      <div
